...
module.exports = {
    ...
    "$shadow-1": "1px 1px 2px 0px rgba(#000000, 0.1)",
    
    "$shadow-1-up": "0px -1px 2px 0px rgba(#000000, 0.1)",
    
    "$shadow-1-right": "1px 0px 2px 0px rgba(#000000, 0.1)",
    
    "$shadow-1-down": "0px 1px 2px 0px rgba(#000000, 0.1)",
    
    "$shadow-1-left": "-1px 0px 2px 0px rgba(#000000, 0.1)",
    
    "$shadow-2": "2px 2px 6px 0px rgba(#FF6A00, 0.3)",
    
    "$shadow-2-up": "0px -2px 6px 0px rgba(#FF6A00, 0.3)",
    
    "$shadow-2-right": "2px 0px 6px 0px rgba(#FF6A00, 0.3)",
    
    "$shadow-2-down": "0px 2px 6px 0px rgba(#FF6A00, 0.3)",
    
    "$shadow-2-left": "-2px 0px 6px 0px rgba(#FF6A00, 0.3)",
    
    "$shadow-3": "4px 4px 10px 0px rgba(#000000, 0.1)",
    
    "$shadow-3-up": "0px -4px 10px 0px rgba(#000000, 0.1)",
    
    "$shadow-3-right": "4px 0px 10px 0px rgba(#000000, 0.1)",
    
    "$shadow-3-down": "0px 4px 10px 0px rgba(#000000, 0.1)",
    
    "$shadow-3-left": "-4px 0px 10px 0px rgba(#000000, 0.1)",
